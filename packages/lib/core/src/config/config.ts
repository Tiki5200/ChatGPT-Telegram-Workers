...
export class EnvironmentConfig {
    ...
    // Diana 固定参考图
    DIANA_HUMAN_REFERENCE_URL = 'https://raw.githubusercontent.com/Tiki5200/ChatGPT-Telegram-Workers/companion-v1/diana-human.PNG';
    DIANA_CAT_REFERENCE_URL = 'https://raw.githubusercontent.com/Tiki5200/ChatGPT-Telegram-Workers/companion-v1/diana-cat.PNG';
    // 模型列表列数
